...
4. *Copy* all needed data, then paste it in `data/realmapp.config.json`. This configuration looks like this:
	...
	"firebase": {
		...
		"ratingsPath": "/ratings",
		"indexedDbSession": "realmapp"
	}
	```
	
5. Import data to the Firebase Database. You can use [default-firebase-data.json](https://github.com/gdg-x/realmapp/blob/master/docs/default-firebase-data.json) schema and then update it with your information.
